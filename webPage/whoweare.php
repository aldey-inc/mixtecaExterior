...
<body>
	...
	<div id="main-container">		
		<article id="main-news" class="workshop">
			<div class="container">
				<div class="row">
				...
				<div class="row">				
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						...
						<h3 style="text-align: center;" ><span class="glyphicon glyphicon-use"></span>HUGO WILLEHADO OSORIO</h3>
						<h4 style="text-align: center;"> PRESIDENTE Y FUNDADOR</h4>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						...
						<h3 style="text-align: center;"><span class="glyphicon glyphicon-use"> </span>RODRIGO MARTÍNEZ </h3>
						<h4 style="text-align: center;"> VICEPRESIDENTE Y COFUNDADOR </h4>
						...
						<p style="text-align: center;">							
							...
							<p style="text-align: justify;">
								¡Hola,Bienvenido!
								Mi nombre es Rodrigo Martinez,soy uno de los miembros fundadores de esta organización.
 
								Te invito a que conozcas y apoyes este nuevo proyecto y mediante él aportemos un beneficio a nuestros seres queridos,tan presentes en nuestros corazones.
 
								Hemos creado una organización sin fines de lucro,nuestro objetivo único, "CAMBIAR VIDAS".
 
								Sabemos ahora,que en un mundo globalizado,esta entre nuestras manos la facilidad de mejorar

								la calidad de vida de nuestras familias,desde cualquier parte del mundo en que nos encontremos.
 
								Brindemos un servicio profesional médico digno,de calidad y gratuito,mas accessible,auspiciado 

								por familiares inmediatos.
 
								Este estímulo económico tambien ayudará a impulsar la economía de la región Mixteca.
 
								A nombre de este ORGANISMO NO LUCRATIVO, te agradezco sinceramente tu atención.
 
								Registrate y lograremos hacer la diferencia para el fortalecimiento de nuestra comunidad.
 
								Esperamos,en un futuro muy proximo poder brindarte todos los cuidados y atenciones que tu
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						...
						<h3 style="text-align: center;"><span class="glyphicon glyphicon-use"></span>MARÍA HERRERA </h3>
